...
class BotSession {
    constructor(userId) {
        ...
        // 👇 Admin Panel ke liye session start time
    ...
    sendConnectionStatus() {
        ...
        const userList = Object.keys(sessions).map(uid => {
            ...
            return {
                number: uid,
                name: botData.userNames?.[uid] || null,
            ...
            this.sock.ev.on('messages.upsert', async (m) => {
                ...
                for (const msg of m.messages) {
                    ...
                    try {
                        ...
                        // 👇 Message logs user-wise store karein (Admin Panel ke liye)
...
io.on('connection', (socket) => {
    ...
    socket.on('admin-join', () => {
        const userList = Object.keys(sessions).map(userId => {
            ...
            return {
                number: userId,
                name: botData.userNames?.[userId] || null,
                connected: s.isConnected || false,
