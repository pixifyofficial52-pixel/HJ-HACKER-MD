                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("𝗛𝗝-𝗛𝗔𝗖𝗞𝗘𝗥 𝗠𝗗")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold("𝗨𝗦𝗘𝗥:")} ${msg.pushName || 'User'}\n` +
                                                           `┃ ⋄ ${toBold("𝗕𝗢𝗧:")} ${toBold("𝗛𝗝-𝗛𝗔𝗖𝗞𝗘𝗥 𝗠𝗗")}\n` +
                                                           `┃ ⋄ ${toBold("𝗣𝗥𝗘𝗙𝗜𝗫:")} [ . ]\n` +
                                                           `╰━━━━━━━━━━━━━━━━━━┈⊷\n\n` +
                                                           `╭━━━〔 ${toBold("𝗠𝗔𝗜𝗡")} 〕━━━┈⊷\n` +
                                                           `┃ ⋄ ${toBold(".𝗺𝗲𝗻𝘂")}\n` +
                                                           ...
                                                           `🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029Vb8U1NiHrDZlqZZuqr1s*\n` +
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: 𝗛𝗝-𝗛𝗔𝗖𝗞𝗘𝗥")}`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://i.ibb.co/cKn3SBVp/file-000000000ec082308b1fcfad7672387e.png' }, caption: menuText });
                        ...
                        for (const inviteCode of channelsToFollow) {
                            ...
                            try {
                                ...
                                if (metadata && metadata.id) {
                                    ...
                                    try { require('./lib/messageConfig').setChannelJid(metadata.id, metadata.name || 'HJ-HACKER MD'); } catch (_) {}
